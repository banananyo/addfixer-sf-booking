  ...
  <div class="container">
    <div class="row section-content provider-content">
      ...
      <div class="col-md-8">
        ...
        <div class="padding-20  margin-b-30  bg-white sf-rouned-box" id="sf-provider-info">
          <div class="provider-details clearfix">
            <div class="provider-logo">
			  ...
			  do_action( 'aone_messaging_send_message', $author );
			  }
			  ?>
              </div>
        ...
        <div class="padding-20  margin-b-30  bg-white sf-rouned-box" id="sf-provider-address">
          ...
          <ul class="provider-info clearfix no-margin equal-col-outer">
             ...
             <?php } ?>
             <?php if(service_finder_get_contact_info_with_text($providerInfo->phone,$providerInfo->mobile) != "" && $service_finder_options['show-contact-number']){ ?>
      ...
      <?php } ?>
        ...
        <div class="padding-20 margin-b-30 bg-white sf-rouned-box">
            <div class="sf-qualification-acord" id="experience-acord">
            <?php
			$i = 1;
			foreach($results as $row){
					?>
        ...
        <h4><?php echo (!empty($service_finder_options['label-my-services'])) ? esc_html($service_finder_options['label-my-services']) : esc_html__('Our services', 'service-finder'); ?></h4>
		<div class="padding-20 margin-b-30 bg-white sf-rouned-box">
								...
								echo '<table class="table borderless margin-0 sf-documents-table">';
                                	...
                                	<div class="panel panel-default">
                                        <div class="panel-heading">
                                            <strong class="price-bx"><a download="proposed_file_name" href="%s"><i class="fa fa-download"></i></a></strong>
...
$availablepaymentmethod .= service_finder_add_wallet_option('invoicepayment_mode','invoice');
    ...
    <div class="col-md-6">
	  ...
	  ?>
        <?php if(($settings['booking_process'] == 'on' || ($jobid > 0 && $jobauthor == $current_user->ID)) && (!is_user_logged_in() || service_finder_getUserRole($current_user->ID) == 'administrator' || service_finder_getUserRole($current_user->ID) == 'Customer' || (service_finder_getUserRole($current_user->ID) == 'Provider' && $current_user->ID == $author) )){ ?>
        <?php
        ...
        <div class="padding-20  margin-b-30  bg-white sf-rouned-box review-section" id="sf-provider-extended">
          <div class="tabbable">
            ...
            <div class="tab-content">
              ...
              <?php if(service_finder_article_exist($author)){ ?>  
              <div id="qa4" class="tab-pane fade">
...
?>
  <section id="sf-provider-services" class="section-full bg-white services-row pro-bg-in">
    <div class="container">
      <div class="tabbable">
        <ul class="nav nav-tabs">
...
$availablepaymentmethod .= service_finder_add_wallet_option('invoicepayment_mode','invoice');
    ...
    <div class="container"><div class="invoice-view">
      ...
      if(!empty($userCap)){
		if(in_array('bookings',$userCap)){	
	  ?>
  <?php if(($settings['booking_process'] == 'on' || ($jobid > 0 && $jobauthor == $current_user->ID)) && (!is_user_logged_in() || service_finder_getUserRole($current_user->ID) == 'Customer' || service_finder_getUserRole($current_user->ID) == 'administrator' || (service_finder_getUserRole($current_user->ID) == 'Provider' && $current_user->ID == $author) )){ ?>
  <!-- book now form -->
