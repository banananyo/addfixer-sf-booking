            ...
            <div id="tab2" class="tab-pane fade in active">
              <form class="provider_registration" method="post">
                <div class="provider-bx clearfix row">
				  ...
				  $result = service_finder_check_only_free_package();
				  if(empty($result)){
				  ?>
                  <div class="col-md-6">
                    <div class="form-group">
				  ...
				  $packageid = (isset($result['packageid'])) ? $result['packageid'] : '';
                  echo '<input type="hidden" name="provider-role" value="package_'.esc_attr($packageid).'" />';
                  }
                  }else{
				  		$withoutpackage = true;
				  } ?>
