...
if($booking == 'complete' && $sender_status == "Completed" && (($sandbox == 'true' && ($status == "COMPLETED" || $status == "INCOMPLETE")) || ($sandbox == 'false' && $status == "COMPLETED"))){
...
if($signup == 'done' && $userid > 0 && $sender_status == "Completed" && (($sandbox == 'true' && ($status == "COMPLETED" || $status == "INCOMPLETE")) || ($sandbox == 'false' && $status == "COMPLETED"))){
