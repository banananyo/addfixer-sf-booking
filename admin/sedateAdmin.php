...
class SERVICE_FINDER_sedateAdmin {
	...
	public function service_finder_addAdminMenu() {
		...
		$payout       = esc_html__( 'Payout History', 'service-finder' );
		$claimbusiness       = $claimbusinessstr;
		$ratinglabels       = esc_html__( 'Rating Labels', 'service-finder' );
		$upgraderequest       = esc_html__( 'Upgrade Request', 'service-finder' );
        ...
        if ( in_array( 'administrator', $current_user->roles ) ) {
            if ( function_exists( 'add_options_page' ) ) {
				...
				add_submenu_page( 'service-finder', $payout, $payout, 'manage_options', 'payout-history',array( $this->payout, 'service_finder_index' ) );
