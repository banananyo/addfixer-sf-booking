...
<div class="panel-heading sf-panel-heading">
  <h3 class="panel-tittle m-a0"><span class="fa fa-money"></span> <?php echo (!empty($service_finder_options['label-experience'])) ? esc_html($service_finder_options['label-experience']) : esc_html__('Experience', 'service-finder'); ?> </h3>
</div>
