...
<div class="panel-heading sf-panel-heading">
  ...
  <div class="sf-cancel-membership"><a href="javascript:;" class="btn btn-danger cancelmembership" data-providerid="<?php echo esc_attr($globalproviderid); ?>"><?php echo esc_html__('Delete Profile', 'service-finder'); ?> </a></div>
  <?php } ?>
</div>
          ...
          <ul class="row sf-plans-list list-unstyled <?php echo sanitize_html_class($packageclass); ?>" id="sf-upgrade-plans">
            ...
            <div id="popover-content-packageinfo-<?php echo esc_attr($i); ?>" class="hide">
                  ...
                  <div class="sf-plans-bx">
                        ...
                        <div class="sf-plans-price"><?php echo esc_html($displayprice); ?></div>
...
echo '<div class="alert alert-warning"><a href="#" class="close hideinfomsg" data-id="'.esc_attr($globalproviderid).'" data-dismiss="alert" aria-label="close">&times;</a>'.esc_html__('Your request has been declined.','service-finder').'</div>';
