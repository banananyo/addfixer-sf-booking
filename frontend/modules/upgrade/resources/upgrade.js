  ...
  jQuery(function() {
	...
	jQuery('.upgrade-form')
        ...
        .on('success.form.bv', function(form) {
				...
				if(woopayment && woooption == '' && jQuery(this).find('input[name=upgrade_woopayment]').length){
					jQuery('.alert').remove();	
			...
			jQuery.ajax({
						...
						success:function (data, textStatus) {
							...
							if(data['status'] == 'success'){
								...
								jQuery( "#feature-req-bx>" ).html( "<div class='alert alert-info'>"+data['suc_message']+"</div>" );
