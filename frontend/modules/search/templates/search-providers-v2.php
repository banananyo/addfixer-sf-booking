...
wp_add_inline_script( 'bootstrap', 'jQuery(document).ready(function($) {
				...
				jQuery("body").on("click", "#viewTypes li", function(){
					...
					window.location = homeurl+"?s=&searchAddress='.esc_js($srhaddress).'&keyword='.esc_js($keyword).'&catid='.esc_js($getcatid).'&country='.esc_js($getcountry).'&city='.esc_js($getcity).'&pagenum="+page+"&viewtype="+viewtype+"&numberofpages="+numberofpages+"&setorderby="+setorderby+"&setorder="+setorder+"&srhbybooking="+srhbybooking;
				...
				jQuery("body").on("change", "#numberofpages", function(){
						...
						window.location = homeurl+"?s=&searchAddress='.esc_js($srhaddress).'&keyword='.esc_js($keyword).'&catid='.esc_js($getcatid).'&country='.esc_js($getcountry).'&city='.esc_js($getcity).'&pagenum=1&viewtype="+viewtype+"&numberofpages="+numberofpages+"&setorderby="+setorderby+"&setorder="+setorder+"&srhbybooking="+srhbybooking;
