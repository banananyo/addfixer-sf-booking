          ...
          <div class="modal-body clearfix row input_fields_wrap">
            ...
            <div class="col-md-12">
			  ...
			  if(!empty($weekdays)){
				...
				echo '<span><input checked data-toggle="toggle" type="checkbox" name="'.esc_attr($weekday).'_status"></span>';
            ...
            <div class="col-md-12">
              <div class="form-group form-inline">
                <label>
                <?php esc_html_e('Offers & Permotions', 'service-finder'); ?>
                </label>
                <br>
      ...
      <div class="col-md-12">
          ...
          <br>
			  ...
			  if(!empty($weekdays)){
				...
				echo '<li>';
				echo '<span>'.$dayname.'</span>';
				echo '<span><input data-toggle="toggle" type="checkbox" name="'.esc_attr($weekday).'_status"></span>';
