...
<ul class="list-unstyled clear sf-plans-available margin-0">
    ...
    <li>
        <h5><?php echo sprintf( esc_html__('Limits with Signup. Package Cycle from %s to %s', 'service-finder'), date('Y-m-d',strtotime($jobstartdate)),date('Y-m-d',strtotime($jobexpire)) ); ?></h5>
        <strong>
		<?php
