  ...
  <form class="book-now" method="post">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="step1">
		...
		?>
          <div class="sf-service-location-area">
              <h6 class="sf-title">
		...
		if(service_finder_booking_date_method($author) == 'multidate'){
			if($settings['booking_charge_on_service'] == 'yes' && !service_finder_is_job_author($jobid,$jobauthor) && !service_finder_is_quotation_author($quoteid,$quoteauthor)){ ?>
