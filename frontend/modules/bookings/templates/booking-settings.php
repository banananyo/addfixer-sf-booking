...
<div class="panel-body sf-panel-body padding-30">
  <div class="row">
    ...
    <div class="col-lg-6" id="bookingdatestyle" <?php echo ($booking_charge_on_service == 'no' || $booking_charge_on_service == '') ? 'style="display: none;"' : ''; ?>>
      <div class="form-group form-inline">
        <label>
...
<?php
  ...
  <div class="panel panel-default password-update">
    <div class="panel-heading sf-panel-heading">
      <h3 class="panel-tittle m-a0"><span class="fa fa-university"></span> <?php esc_html_e('Bank Account Details', 'service-finder'); ?> <i class="tip-info fa fa-question" data-toggle="tooltip" title="<?php echo esc_html__('Bank details will be used by admin to pay your booking amount to your bank account once service is delivered', 'service-finder'); ?>"></i></h3>
    </div>
    <div class="panel-body sf-panel-body padding-30">
      <div class="row">
        <div class="col-lg-6">
