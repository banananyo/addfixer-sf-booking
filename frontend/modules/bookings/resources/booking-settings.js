...
// When the browser is ready...
  jQuery(function() {
	...
	.on('change', 'input[type="radio"][name="booking_charge_on_service"]', function() {
                var booking_charge_on_service   = jQuery(this).val();

                if (booking_charge_on_service == 'yes') {
					jQuery('#bookingdatestyle').show();
                } else {
					jQuery('#bookingdatestyle').hide();
				}
         })
