...
if(identitycheckfeature > 0 && identityupload == "no" && restrictmyaccount > 0){
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <div class="input-group"> <i class="input-group-addon fixed-w fa fa-fax"></i>
              <input type="text" class="form-control sf-form-control" name="fax" value="<?php echo esc_attr($userInfo['fax']) ?>">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <div class="input-group"> <i class="input-group-addon fixed-w fa fa-google-plus sf-color-social"></i>
              <input type="text" class="form-control sf-form-control" name="google_plus" value="<?php echo esc_attr($userInfo['google_plus']) ?>">
            </div>
          </div>
        </div>
        <div class="col-lg-6">
        ...
        <div class="col-md-12">
          <div class="rwmb-field rwmb-oembed-wrapper">
            ...
            <div class="rwmb-input ui-sortable">
              <input type="url" size="30" placeholder="<?php echo esc_html__('Insert YouTube or Vimeo or Facebook Vedio Url', 'service-finder') ?>" value="" id="embeded_code" name="embeded_code" class="rwmb-oembed valid form-control sf-form-control">
