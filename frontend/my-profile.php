...
var joblimitstab = "'.$joblimitstab.'";', 'after' );
...
var user_id = "'.$globalproviderid.'";', 'after' );
        ...
        <div class="col-md-12">
        <div class="alert alert-info alert-dismissable address-alert" id="sf-address-alert" style="display:none"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
        <?php echo (!empty($service_finder_options['myaccount-notification'])) ? esc_html($service_finder_options['myaccount-notification']) : esc_html__('Please fill address to set your visiblity on google map', 'service-finder'); ?>
        </div>
        </div>
        <?php } ?>
        ...
        <nav id="sidebar-admin-wraper">
            ...
            <aside  class="side-bar">
                ...
                <li class="<?php echo ($tabname == 'payout-settings') ? 'active' : ''; ?>">
                  <a href="#payout-settings"><i class="fa fa-money"></i><span class="admin-nav-text"><?php echo (!empty($service_finder_options['label-payout-setting'])) ? esc_html($service_finder_options['label-payout-setting']) : esc_html__('Payout Settings', 'service-finder'); ?></span></a>
				...
				}elseif($payment_methods['stripe'] && $stripeconnecttype == 'custom'){
				?>
                <li class="<?php echo ($tabname == 'payout-general') ? 'active' : ''; ?>">
                  ...
                  <ul class="sub-menu" style="display: <?php echo ($tabname == 'payout-general' || $tabname == 'identity-verification' || $tabname == 'external-account') ? 'block' : 'none'; ?>;">
                            <li class="<?php echo ($tabname == 'payout-general') ? 'active' : ''; ?>"><a href="#payout-general"><i class="fa fa-user"></i>
                              <?php echo esc_html__('General', 'service-finder'); ?>
                              </a></li>
                            <li class="<?php echo ($tabname == 'identity-verification') ? 'active' : ''; ?>"><a href="#identity-verification"><i class="fa fa-user"></i>
                              <?php echo esc_html__('Identity Verification', 'service-finder'); ?>
                              </a></li>
                            <li class="<?php echo ($tabname == 'external-account') ? 'active' : ''; ?>"><a href="#external-account"><i class="fa fa-user"></i>
                              <?php echo esc_html__('External Account', 'service-finder'); ?>
                              </a></li>
                            <li class="<?php echo ($tabname == 'payout-history') ? 'active' : ''; ?>"><a href="#payout-history"><i class="fa fa-money"></i>
                              <?php echo esc_html__('Payout History', 'service-finder'); ?>
                              </a></li>        
                ...
                <?php echo (!empty($service_finder_options['label-offers'])) ? esc_html($service_finder_options['label-offers']) : esc_html__('Offers & Permotions', 'service-finder'); ?>
                </a></li>
                <?php } ?>
        ...
        <div class="tab-content content-admin-main col-md-91">
          ...
          <div id="identity-verification" class="tab-pane fade <?php echo ($tabname == 'identity-verification') ? 'in active' : ''; ?>">
            <?php require SERVICE_FINDER_BOOKING_FRONTEND_MODULE_DIR . '/payout/templates/identity-verification.php'; ?>
          </div>
          <div id="external-account" class="tab-pane fade <?php echo ($tabname == 'external-account') ? 'in active' : ''; ?>">
            <?php require SERVICE_FINDER_BOOKING_FRONTEND_MODULE_DIR . '/payout/templates/external-account.php'; ?>
          </div>
          <div id="payout-history" class="tab-pane fade <?php echo ($tabname == 'payout-history') ? 'in active' : ''; ?>">
        ...
        <nav id="sidebar-admin-wraper">
            <div class="page-logo">
                <?php 
				echo '<a href="'.esc_url(home_url()).'">';
				if(!empty($service_finder_options['site-logo']['url'])){
				echo '<img src="'.esc_url($service_finder_options['site-logo']['url']).'" alt="'.esc_attr(get_bloginfo('name')).'" title="'.esc_attr(get_bloginfo('name')).'">';
				}else{
				echo get_bloginfo('name');
				}
        ...
        <a href="<?php echo esc_url(add_query_arg( array('action' => 'my-profile'), $accounturl )) ?>"><i class="fa fa-user"></i><span class="admin-nav-text"><?php esc_html_e('My Profile', 'service-finder'); ?></span></a>
        </li>
